...
export default function CVForm({cv,onPersonalChange,onAddExp,onExperienceChange}) {
  ...
  return (
    <div className="w-[210mm] flex flex-col shadow-lg rounded border p-4 bg-gray-100 gap-2 ">
      ...
      <Experience experience={cv.experience} onAdd={onAddExp} onChange={onExperienceChange}/>
      <Education />
      <Section>
